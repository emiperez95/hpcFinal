...
class Topology_manager():
    ...
    def __init__(self,cc):
        self.root = cc["mpi"]["root"]
        nodes_info = cc["nodes_rank"]
        ...
        for i, node in enumerate(nodes_info):
            ...
            # node_topology
            if node["node_name"] not in self.node_topology:
                self.node_topology[node["node_name"]] = set([])
            self.node_topology[node["node_name"]].add(i)
